...
export default function Home() {
  return (
    <main className='min-h-screen flex justify-center'>
      <div className='pt-20'>
        <div className='max-w-lg lg:max-w-3xl bg-white px-12 py-16 rounded-md shadow-md flex flex-col md:flex-row justify-between gap-6'>
